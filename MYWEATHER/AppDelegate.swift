...
class AppDelegate: UIResponder, UIApplicationDelegate, GIDSignInDelegate {
    ...
    // Check this approach for future development in order to ease AppDelegate from unneeded stuff
...
//        self.saveContext()
    ...
    // Why do you need Core Data stack in AppDelegate if you have PersistenseService ???
